...
class School5_Luxtax_Model_Sales_Quote_Address_Total_Luxutax extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
     * Get label
     *
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        $baseLuxuryTaxAmount = $this->_getBaseTaxAmount();
