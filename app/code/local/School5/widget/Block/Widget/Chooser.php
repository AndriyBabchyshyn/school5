<?php
class School5_widget_Block_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/widget/chooser', array('uniq_id' => $uniqId));
    ...
    {
        return $this->getUrl('*/widget/chooser', array('_current' => true));
    }
}
