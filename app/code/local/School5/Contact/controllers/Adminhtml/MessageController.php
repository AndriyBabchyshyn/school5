...
class School5_Contact_Adminhtml_MessageController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('School5/training_contact')
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('School5/training_contact');
    }
}